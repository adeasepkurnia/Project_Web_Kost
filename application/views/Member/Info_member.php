					...
					<div class="row costumrow">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
							<div class="featurecontant">
								...
								<center><a href="<?php echo base_url()."Pesan/pemesanan/".$value->id_hunian?>" class="btn btn-success">PESAN</a>
									<a href="<?php echo base_url()."Sewa/tambah/".$value->id_hunian?>" class="btn btn-info">BAYAR SEWA</a>

									<a href="<?php echo base_url()."Komplain/tambah/".$value->id_hunian?>" class="btn btn-danger">KOMPLAIN</a>	
								</center>
