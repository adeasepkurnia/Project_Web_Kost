<nav class="topnavbar navbar-default topnav">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand logo" href="#"><img width="80" src="<?php echo base_url();?>assets/image/123.png" alt="logo"></a>
				</div>	 
			</div>
			<div class="collapse navbar-collapse text-danger" id="upmenu">
